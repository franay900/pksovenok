        ...
        <div class="flex flex-col items-center justify-center">
            ...
            <div style="border-radius: 56px; padding: 0.3rem; background: linear-gradient(180deg, color-mix(in srgb, var(--primary-color), transparent 60%) 10%, var(--surface-ground) 30%)">
                <div class="w-full bg-surface-0 dark:bg-surface-900 py-20 px-8 sm:px-20 flex flex-col items-center" style="border-radius: 53px">
                    ...
                    <div class="text-surface-600 dark:text-surface-200 mb-8">Страница не найдена</div>
                    <router-link to="/" class="w-full flex items-center py-8 border-surface-300 dark:border-surface-500 border-b">
                        ...
                        <span class="ml-6 flex flex-col">
                            <span class="text-surface-900 dark:text-surface-0 lg:text-xl font-medium mb-0 block">Главная страница</span>
                            <span class="text-surface-600 dark:text-surface-200 lg:text-xl">Попробуйте перейти на эту страницу еще раз.</span>
                        </span>
                    </router-link>
                    <router-link to="/" class="w-full flex items-center py-8 border-surface-300 dark:border-surface-500 border-b">
                        <span class="flex justify-center items-center border-2 border-primary text-primary rounded-border" style="height: 3.5rem; width: 3.5rem">
                        ...
                        <span class="ml-6 flex flex-col">
                            <span class="text-surface-900 dark:text-surface-0 lg:text-xl font-medium mb-0">Служба технической поддержки</span>
                            <span class="text-surface-600 dark:text-surface-200 lg:text-xl">Если на этом месте должна быть страница, обратитесь в поддержку.</span>
                        </span>
                    </router-link>
                    <router-link to="/" class="w-full flex items-center mb-8 py-8 border-surface-300 dark:border-surface-500 border-b">
                        ...
                        <span class="ml-6 flex flex-col">
                            <span class="text-surface-900 dark:text-surface-0 lg:text-xl font-medium mb-0">Ограничение прав</span>
                            <span class="text-surface-600 dark:text-surface-200 lg:text-xl">Возможно, у вас нет прав на просмотр этой страницы</span>
                        </span>
                    </router-link>
                    <Button as="router-link" label="Перейти в личный кабинет" to="/" />
                </div>
            </div>
        </div>
    </div>
